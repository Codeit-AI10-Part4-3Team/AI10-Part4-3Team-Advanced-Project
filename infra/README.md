...
| 2026-08-10 | `sprinter_vm_role_v1` 포함 권한 | **조회 불가.** 실측 프로브로만 확인 가능 |
| TBD | 방화벽 규칙 생성 / 고정 IP 예약 / 스냅샷 스케줄 생성 / API 활성화 | 미확인 |
...
- **ai-engine은 방화벽이 아니라 compose로 막습니다.** `ports:`를 `"127.0.0.1:8100:8100"`으로
