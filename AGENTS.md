...
- **마일스톤 일자도 TBD가 아닙니다** — 2026-08-21 회의록으로 전체 확정됐습니다(미결정_대장
  ...
  넷입니다** — N19-a(재시도 횟수와 이음매별 배치, 이슈 #180), B-11 이 닫히면서 나온 확인
  한 건, N23(`Accepted` ADR 의 본문 치환 조건, PR #264 리뷰), N26(사용자가 쓴 `note` 가 칸
  역할의 금지를 이김, 이슈 #282). 한때 이 목록에 있던 N21(브랜드 스타일 일치도 행 처리)은
  **2026-08-25 회의가 닫았고**, 08-26 에 N22 · N23 · N26 이 붙었습니다.
