...
- **마일스톤 일자도 TBD가 아닙니다** — 2026-08-21 회의록으로 전체 확정됐습니다(미결정_대장
  ...
  하나입니다** — N19-a(재시도 횟수와 이음매별 배치, 이슈 #180). 한때 이 목록에 있던 것들은
  전부 닫혔습니다 — N21(브랜드 스타일 일치도 행 처리)은 **2026-08-25 회의**, N22(스텁에서
  만화형을 눌렀을 때의 처리, 이슈 #271)와 N23(`Accepted` ADR 의 본문 치환 조건)과 N26(사용자가
  쓴 `note` 가 칸 역할의 금지를 이김, 이슈 #282)은 **2026-08-27 회의**(안건 02 · 12 · 08),
  B-11 이 닫히면서 나온 확인 한 건은 **2026-08-28 회의**(안건 06)가 닫았습니다.
  ⚠️ **정본인 [미결정_대장.md](docs/기술문서/미결정_대장.md)가 아직 08-27 · 08-28 회의를
  반영하지 않았습니다** — 그 갱신 전까지 대장의 "다음 회의를 기다리는 것" 목록을 그대로 읽으면
  이미 닫힌 항목을 안건으로 다시 잡게 됩니다. **확정의 근거는 대장이 아니라 회의록입니다**
  (위 근거 자료 규칙 2번). 회의 이후에 생긴 안건은 회의록에 없습니다.
