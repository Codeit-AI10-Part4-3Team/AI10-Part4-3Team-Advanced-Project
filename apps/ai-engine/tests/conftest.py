...
def contract_schemas() -> dict[str, Any]:
    ...
    Skips rather than fails when the file is missing — this app is independently
    deployable, and a missing monorepo sibling is an environment fact, not a broken model.
    """
