...
- **마일스톤 일자도 TBD가 아닙니다** — 2026-08-21 회의록으로 전체 확정됐습니다(미결정_대장
  B-20, 마지막 차단이었습니다). 정본:
  [docs/역할_일정/00-overall.md](docs/역할_일정/00-overall.md). 회의가 미룬 것은 실험 예산
  상한 · B-9 · B-11 셋이며 "다음 회의"로 예약되어 있습니다
  ([2026-08-21 일정 확정 회의록](docs/회의록/2026-08-21_일정_확정.md)). 그 뒤 **재시도 정책
  한 건이 더 붙어 회의 대상은 넷입니다** (N19-a, 이슈 #180 - 회의 이후에 생긴 안건이라 위
  회의록에는 없고 미결정_대장에만 있습니다)
