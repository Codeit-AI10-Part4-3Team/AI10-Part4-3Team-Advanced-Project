...
> ([미결정_대장.md](../기술문서/미결정_대장.md) B-20). 미결정 5건은 **2026-08-21 회의로
> 확정되었고** ([회의록](../회의록/2026-08-21_미결정_5건_확정.md)) 그 결정이 이 문서에 반영되어
> 있습니다. **일정 자체(B-20)의 확정 회의록은 별도 예정**이며
> ([안건지 초안](../회의록/2026-08-21_일정_확정.md)), 그것이 커밋되면 이 안내와 각 역할 문서의
> "TL 초안" 안내를 지웁니다. 그 전에는 아래 날짜를 지연 판정의 근거로 쓰지 마세요.
>
...
2. **스켈레톤 이후 구간을 이제 계획할 수 있게 되었습니다.** 08-11 판은 관통까지만 유효했고
   ...
   **코드 강제 검사는 만들지 않음**(B4 보류), 장면 상태는 이번 범위 제외 + 참고 표기, D2는
   델타 대신 **절대값 보고**, 타임아웃은 #153 값 추인. 남은 회의 몫은 일정 자체(B-20)입니다.
...
| 전제 | 걸려 있는 것 | 어긋나면 |
|---|---|---|
| ~~08-21 회의가 미결정 4건을 닫음~~ | ~~B4, D2, 3순위 확정~~ | **해소 (08-21).** 5건이 확정되었습니다 ([회의록](../회의록/2026-08-21_미결정_5건_확정.md)). 남은 전제는 B-20 확정 회의록(별도 예정) - 없으면 TL 초안 안내를 지울 수 없고 지연 판정 근거도 계속 없습니다 |
...
| **미결정 5건 확정** | **2026-08-21** | **달성** ([회의록](../회의록/2026-08-21_미결정_5건_확정.md) - N18, A-4 장면 상태, D2, 타임아웃, A-6). **일정 자체(B-20)는 별도 회의록 대기** - 그것이 커밋되어야 이 문서의 "TL 초안" 안내가 제거됩니다 ([안건지 초안](../회의록/2026-08-21_일정_확정.md)) |
...
- **회의 몫이던 4건은 08-21 회의로 닫혔습니다** ([회의록](../회의록/2026-08-21_미결정_5건_확정.md)).
  ...
  대체되고, D2는 재실험 없이 **절대값 보고 정리**로 줄었습니다. 남은 회의 몫은 일정
  자체(B-20)뿐입니다.
