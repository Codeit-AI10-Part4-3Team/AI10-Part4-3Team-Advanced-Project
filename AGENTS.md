...
- **마일스톤 일자도 TBD가 아닙니다** — 2026-08-21 회의록으로 전체 확정됐습니다(미결정_대장
  ...
  한 건, **N22(스텁에서 만화형을 눌렀을 때의 처리 — 2026-08-26 에 열린 `차단`, 이슈 #271)**,
  N23(`Accepted` ADR 의 본문 치환 조건, PR #264 리뷰). 여기 셋째로 적혀 있던 N21(브랜드
  스타일 일치도 행 처리)은 **2026-08-25 회의가 닫았고**, 08-26 에 N22 와 N23 이 붙었습니다.
  **차단이 0건이 아니게 된 것은 N22 부터입니다** — 만화형 시안 화면이 N22 에 걸려 있어,
  닫히지 않으면 제출까지 화면에서 열리지 않습니다. 목록의 정본은
