...
- **한글 카피 렌더링에서 로컬 후보 셋이 전부 실패했습니다.** FLUX.1-schnell은 한국어
  카피 자체가 불가하고, negative prompt로 글자를 빼는 것도 10장 중 0장만 성공했습니다
  (글자 없음 0/10 - "카피를 정확히 그렸다"가 아니라 "안 그리라는 지시를 못 지켰다"는
  뜻입니다). Qwen-Image Q4는 한글 글자꼴은 그리지만 철자 정확도가 0/5입니다(1088 x 1088
  단일 광고형 조건). 각각의 조건에서, gpt-image-2는 3456 x 2304 만화형, 짧은 대사
  (9 ~ 15자) 조건으로 120칸 오탈자 0건입니다 - 두 수치는 서로 다른 실험이라 직접 비교
  대상은 아닙니다
