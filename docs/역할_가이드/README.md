...
**2026-08-10에 배정이 끝났습니다.** 아래 표는 그때 참고한 것이며, 실제 배정은 위 역할 목록이
정본입니다. 아래 세 안 중 어느 것과도 정확히 같지 않습니다. 겸임을 01+07(정승호)과
03+04(임유빈) 둘로 묶어 금지 조합 셋을 모두 피했습니다.

역할을 다시 나눌 일이 생기면 위 금지 조합만은 피하세요.
...
2026-08-10 배정 시점의 확인 결과입니다. 배정을 바꾸면 넷을 다시 확인하세요.

- [x] `CODEOWNERS`의 **모든 경로에 오너가 2명 이상**인가 - 전 경로 충족
