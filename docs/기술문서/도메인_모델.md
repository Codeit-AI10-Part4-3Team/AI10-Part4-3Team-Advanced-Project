...
| 필드 | 규칙 | 근거 |
|---|---|---|
| `productImage` | 1장. **JPEG / PNG / WebP**, 최대 **10MB**, 짧은 변 **512px 이상** | 9.1 |
...
- `dialogue`(생성물) 상한은 여기 없습니다. 한국어 렌더링 검증 결과에 종속됩니다 (5.1절, 18.1 #1).
...
| 항목 | 상태 |
|---|---|
| `dialogue` 길이 상한 | 미정. 렌더링 검증 결과에 종속 (18.1 #1) |
...
**확정되었습니다** (3.1절, [API_계약.md](API_계약.md) 3절). 남은 넷은 전부 타 소관이거나 실험
결과에 종속됩니다.
